...
class TestEventHandlers(ExtendedTestCase):
	...
	def testCityAcquired(self):
		...
		onCityAcquired(PlayerContainer(0), (1, 0, city, False))
		self.assertEqual(self.iCallCount, 1)
		
		onCityAcquired(PlayerContainer(1), (1, 0, city, False))
		self.assertEqual(self.iCallCount, 1)
	...
	def testGreatPersonBorn(self):
		...
		onGreatPersonBorn(PlayerContainer(0), (None, 0))
		self.assertEqual(self.iCallCount, 1)
		
		onGreatPersonBorn(PlayerContainer(1), (None, 0))
		self.assertEqual(self.iCallCount, 1)
