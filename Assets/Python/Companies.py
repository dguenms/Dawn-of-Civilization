...
tCompanyTechs = (con.iCurrency, con.iExploration, con.iBiology, con.iRefrigeration, con.iThermodynamics, con.iMetallurgy, con.iCombustion, con.iElectricity, con.iComputers)
