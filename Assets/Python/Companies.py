...
tCompanyTechs = (con.iCurrency, con.iExploration, con.iBiology, con.iRefrigeration, con.iThermodynamics, con.iMetallurgy, con.iRefining, con.iElectricity, con.iComputers)
