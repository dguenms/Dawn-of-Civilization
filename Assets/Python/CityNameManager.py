...
iLangNorse, iLangArabian, iLangKhmer, iLangIndonesian, iLangSpanish, 
...
dCapitals = {
	...
	iDravidia : ["Madurai", "Thiruvananthapuram", "Cochin", "Kozhikode"],
	iArabia : ["Dimashq"],
...
def onCityAcquired(iOwner, iNewOwner, city):
	...
	elif sOldName == 'York' and iNewOwnerCiv == iCanada and city.getRegionID() == rOntario: sNewName = 'Toronto'
