...
dAdditionalPaganGoal = {
	...
	iBidaism: ResourceCount((iGold, 5), (iSalt, 5), (iIvory, 5)),
	iBon: PeakCount(50),
	iBukongo: ResourceCount((iGems, 8), (iIvory, 6)),
	...
	iTeotlToltec: CityBuilding(capital().named(CAPITAL), iPyramidOfTheSun, iTempleOfKukulkan, iFloatingGardens),
