...
iCivItaly : 	Techs([iCommune, iPaper, iCompass, iClergy], column=7),
iCivMughals :	Techs([iCommune, iCropRotation, iClergy, iGunpowder], column=7),
iCivTurkey :	Techs([iCommune, iCropRotation, iPaper, iClergy, iGunpowder], column=7),
