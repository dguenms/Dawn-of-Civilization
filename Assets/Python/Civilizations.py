...
iCivKorea : 	techs(lAncientTechs, [iBloomery, iMetalCasting, iGeometry, iContract, iWriting, iPriesthood, iNavigation,
...
iCivMaya : 		[iTanning, iMining, iPottery, iAgriculture, iWorship, iSailing,
				...
				iConstruction],
iCivByzantium :	techs(lAncientTechs, [iBloomery, iMetalCasting, iGeometry, iContract, iWriting, iPriesthood, iNavigation,
				iGeneralship, iEngineering, iAesthetics, iCurrency, iLaw, iPhilosophy, iMedicine,
				iSteel, iArchitecture, iPolitics, iEthics,
				iMachinery,]),
iCivJapan : 	techs(lAncientTechs, [iBloomery, iMetalCasting, iGeometry, iContract, iWriting, iPriesthood, iNavigation,
...
iCivVikings : 	techs(lAncientTechs, [iBloomery, iMetalCasting, iGeometry, iContract, iWriting, iPriesthood, iNavigation,
				iGeneralship, iEngineering, iCurrency, iLaw,
				iSteel, iArtisanry, iPolitics,
				iFeudalism, iMachinery]),
iCivArabia : 	techs(lAncientTechs, [iBloomery, iMetalCasting, iGeometry, iContract, iWriting, iPriesthood, iNavigation,
				iGeneralship, iEngineering, iCurrency, iLaw, 
				iSteel, iNobility, iArtisanry, iPolitics, iEthics,
				iMachinery, iAlchemy, iTheology, iClergy]),
iCivTibet :		techs(lAncientTechs, [iBloomery, iMetalCasting, iGeometry, iContract, iWriting, iPriesthood, iNavigation,
				iGeneralship, iEngineering, iCurrency, iLaw, iPhilosophy,
...
iCivKhmer : 	techs([iTech for iTech in lAncientTechs if iTech != iShipbuilding],
				...
				iGeneralship, iEngineering, iCurrency, iLaw, iMedicine,
				iSteel, iNobility, iArchitecture, iPolitics, iEthics,
				iMachinery, iTheology]),
iCivIndonesia :	techs(lAncientTechs, [iBloomery, iMetalCasting, iGeometry, iContract, iWriting, iPriesthood, iNavigation,
				iGeneralship, iEngineering, iCurrency, iLaw, iMedicine,
				iSteel, iNobility, iArchitecture, iArtisanry, iEthics,
				iMachinery, iJudiciary]),
iCivMoors : 	techs(lAncientTechs, [iBloomery, iMetalCasting, iGeometry, iContract, iWriting, iPriesthood, iNavigation,
				iGeneralship, iEngineering, iAesthetics, iCurrency, iLaw, iPhilosophy, iMedicine,
				iSteel, iArchitecture, iArtisanry, iEthics,
				iMachinery, iAlchemy, iTheology,
				iClergy]),
iCivSpain : 	techs(lAncientTechs, [iBloomery, iMetalCasting, iGeometry, iContract, iWriting, iPriesthood, iNavigation,
				iGeneralship, iEngineering, iCurrency, iLaw, iPhilosophy,
				iSteel, iNobility, iArchitecture, iArtisanry, iPolitics, iEthics,
				iWarriorCode, iFeudalism, iMachinery, iTheology,
				iClergy]),
iCivFrance : 	techs(lAncientTechs, [iBloomery, iMetalCasting, iGeometry, iContract, iWriting, iPriesthood, iNavigation,
				iGeneralship, iEngineering, iCurrency, iLaw, iPhilosophy,
				iSteel, iNobility, iArchitecture, iArtisanry, iPolitics, iEthics,
				iWarriorCode, iFeudalism, iMachinery, iTheology,
				iClergy]),
iCivEngland : 	techs(lAncientTechs, [iBloomery, iMetalCasting, iGeometry, iContract, iWriting, iPriesthood, iNavigation,
				iGeneralship, iEngineering, iCurrency, iLaw, iPhilosophy,
				iSteel, iNobility, iArchitecture, iArtisanry, iPolitics, iEthics,
				iWarriorCode, iFeudalism, iMachinery, iTheology,
				iClergy]),
iCivHolyRome : 	techs(lAncientTechs, [iBloomery, iMetalCasting, iGeometry, iContract, iWriting, iPriesthood, iNavigation,
				iGeneralship, iEngineering, iCurrency, iLaw, iPhilosophy,
				iSteel, iNobility, iArchitecture, iArtisanry, iPolitics, iEthics,
				iWarriorCode, iFeudalism, iMachinery, iTheology,
				iClergy]),
iCivRussia : 	techs(lAncientTechs, [iBloomery, iMetalCasting, iGeometry, iContract, iWriting, iPriesthood, iNavigation,
				iGeneralship, iEngineering, iCurrency, iLaw, iPhilosophy,
				iSteel, iNobility, iArchitecture, iArtisanry, iPolitics, iEthics,
				iWarriorCode, iFeudalism, iMachinery, iTheology,
				iClergy]),
iCivMali :		[iTanning, iMining, iPottery, iPastoralism, iAgriculture, iWorship,
				...
				iTheology],
iCivPoland : 	techs(lAncientTechs, [iBloomery, iMetalCasting, iGeometry, iContract, iWriting, iPriesthood, iNavigation,
				iGeneralship, iEngineering, iAesthetics, iCurrency, iLaw, iPhilosophy, iMedicine,
...
iCivMongols :	techs([iTech for iTech in lAncientTechs if iTech != iShipbuilding], 
				[iBloomery, iMetalCasting, iGeometry, iContract, iWriting, iPriesthood,
				iGeneralship, iEngineering, iCurrency, iLaw, iPhilosophy, iMedicine,
...
iCivCanada : 	techs(lRenaissanceTechs, [iMachineTools, iThermodynamics, iMetallurgy, iChemistry, iBiology, iRepresentation, iNationalism,
				iRailroad, iLaborUnions, iJournalism]),
},
{
iCivIndependent : 	techs(lAncientTechs, [iBloomery, iMetalCasting, iGeometry, iContract, iWriting, iPriesthood, iNavigation,
					iGeneralship, iEngineering, iAesthetics, iCurrency, iLaw, iMedicine,
					iSteel, iNobility, iArchitecture, iArtisanry]),
iCivIndependent2 : 	techs(lAncientTechs, [iBloomery, iMetalCasting, iGeometry, iContract, iWriting, iPriesthood, iNavigation,
					iGeneralship, iEngineering, iAesthetics, iCurrency, iLaw, iMedicine,
					iSteel, iNobility, iArchitecture, iArtisanry]),
