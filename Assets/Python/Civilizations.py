...
iCivRome : 	Techs([iBloomery, iMetalCasting, iMathematics, iTradition], column=3, exceptions=[iRiding, iCalendar, iShipbuilding]),
...
iCivInca : 	Techs([iMathematics, iContract, iTradition, iPriesthood], column=3, exceptions=[iSeafaring, iAlloys, iRiding, iShipbuilding]),
iCivMongols :	Techs([iPaper, iCompass], column=7, exceptions=[iTheology]),
iCivAztecs :	Techs([iMathematics, iContract, iTradition, iPriesthood, iGeneralship, iAesthetics, iCurrency, iLaw], column=3, exceptions=[iSeafaring, iAlloys, iRiding, iShipbuilding]),
iCivItaly : 	Techs([iCharter, iPaper, iCompass, iClergy], column=7),
iCivMughals :	Techs([iCharter, iCropRotation, iClergy, iGunpowder], column=7),
iCivTurkey :	Techs([iCharter, iCropRotation, iPaper, iClergy, iGunpowder], column=7),
...
iCivFrance :	Techs([iReplaceableParts, iPhysics, iMeasurement, iConstitution], column=11),
