...
## Platy Builder ##
	...
	def mouseOverPlot (self, argsList):
		...
		if not CyInterface().isInAdvancedStart():
			sText = "<font=3b>%s, X: %d, Y: %d, City: %s, Region: %s</font>" %(CyTranslator().getText("TXT_KEY_WB_LATITUDE",(self.m_pCurrentPlot.getLatitude(),)), x, y, cn.getName(game.getActivePlayer(), self.m_pCurrentPlot), self.m_pCurrentPlot.getRegionName())
