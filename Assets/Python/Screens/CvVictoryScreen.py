...
# BUG Additions End
	...
	def drawMarsBaseScreen(self):
		...
		screen.addToModelGraphicGFC(szImage, "Art/Interface/Screens/MarsScreen/Environment/marsfield.nif")
		
		# Central base
		screen.addToModelGraphicGFC(szImage, "Art/Interface/Screens/MarsScreen/Base/MarsColony_Base.nif")
		...
		for i, iComponent in enumerate(lMarsColonyComponents):
			for iNum in range(gc.getProjectInfo(iComponent).getMaxTeamInstances()):
				if gc.getTeam(gc.getPlayer(self.iActivePlayer).getTeam()).getProjectCount(iComponent) > iNum:
					sNifKey = "Art/Interface/Screens/MarsScreen/Component_" + str(i) + "/MarsColony_" + str(i) + "_" + str(iNum) + ".nif"
