	...
	def drawContents(self):
		...
		for city in PlayerUtil.playerCities(player):
			if not city.isDisorder():
				...
				fCitySpecialists += (city.getSpecialistPopulation() + city.getNumGreatPeople() - city.getFreeSpecialistCount(con.iSpecialistSlave)) * player.getSpecialistExtraCommerce(CommerceTypes.COMMERCE_GOLD)
