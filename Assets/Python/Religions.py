...
## JUDAISM
	...
	def spreadJudaismEurope(self, iGameTurn):
		self.spreadReligionToRegion(iJudaism, [rIberia, rFrance, rLowerGermany, rCentralEurope, rPoland, rItaly, rBritain, rRuthenia, rBalkans, rGreece], iGameTurn, 1000, 10, 0)
				
	def spreadJudaismMiddleEast(self, iGameTurn):
		self.spreadReligionToRegion(iJudaism, [rLevant, rMesopotamia, rAnatolia, rEgypt, rNubia, rEthiopia, rMaghreb], iGameTurn, 600, 20, 5)
		
	def spreadJudaismAmerica(self, iGameTurn):
		self.spreadReligionToRegion(iJudaism, [rMaritimes, rQuebec, rOntario, rAtlanticSeaboard, rMidwest, rGreatPlains, rCalifornia, rCascadia], iGameTurn, 1850, 10, 4)
