...
iNativeAmericans, iNetherlands, iNubia, iOttomans, iPersia, iPoland, iPolynesia, iPortugal, iRome, iRus, 
iRussia, iSpain, iSumeria, iSwahili, iSweden, iTamils, iThailand, iTibet, iToltecs, iTurks, 
...
dCivGroups = {
iCivGroupEurope : [iGreece, iRome, iCelts, iByzantium, iVikings, iSpain, iFrance, iEngland, iHolyRome, iRus, iItaly, iPoland, iPortugal, iSweden, iRussia, iNetherlands, iGermany],
iCivGroupAsia : [iIndia, iChina, iHarappa, iPolynesia, iPersia, iJapan, iTamils, iKushans, iKorea, iKhmer, iMalays, iJava, iTibet, iBurma, iVietnam, iMongols, iMughals, iThailand, iRussia, iTurks],
...
iCivGroupAfrica : [iEgypt, iCarthage, iNubia, iEthiopia, iSwahili, iMali, iCongo],
...
dTechGroups = {
iTechGroupWestern : [iRome, iGreece, iCelts, iByzantium, iVikings, iSpain, iFrance, iEngland, iHolyRome, iRus, iPoland, iPortugal, iItaly, iSweden, iRussia, iNetherlands, iGermany, iAmerica, iArgentina, iMexico, iColombia, iBrazil, iCanada],
iTechGroupMiddleEast : [iEgypt, iBabylonia, iHarappa, iAssyria, iHittites, iIndia, iCarthage, iNubia, iPersia, iEthiopia, iKushans, iArabia, iMoors, iSwahili, iMali, iOttomans, iMughals, iTamils, iCongo, iTurks, iIran],
...
iStrelets, iJanissary, iOromoWarrior, iQizilbash, iMohawk, iMusketeer, iRedcoat, iCarolean, iFusilier, iMinuteman, 
iRifleman, iMehalSefari, iGrenadier, iRocketeer, iGrenzer, iAlbionLegion, iAntiTank, iInfantry, iSamInfantry, iMobileSam, 
iMarine, iNavySeal, iParatrooper, iMechanizedInfantry, iArcher, iAsharittuBowman, iMedjay, iNativeArcher, iSkirmisher, iHolkan, 
iAtlAtl, iKelebolo, iLongbowman, iPatiyodha, iRattanArcher, iCrossbowman, iChokonu, iBalestriere, iChariot, iWarChariot, 
...
iPistolier, iHakkapeliitta, iMountedBrave, iCamelGunner, iCuirassier, iGendarme, iConquistador, iWingedHussar, iHussar, iCossack, 
iLlanero, iDragoon, iGuard, iCassay, iGrenadierCavalry, iCavalry, iRural, iWarElephant, iBallistaElephant, iTank, 
iPanzer, iMainBattleTank, iGunship, iCatapult, iSiegeRam, iBallista, iTrebuchet, iBombard, iHwacha, iSiegeElephant, 
iGreatBombard, iCannon, iArtillery, iMachineGun, iHowitzer, iMobileArtillery, iWorkboat, iGalley, iWaka, iBireme, 
...
iGer, iLibrary, iEdubba, iTaixue, iKyaung, iHoTrai, iSangam, iHarbor, iAqueduct, iBaray, 
iNoria, iStepwell, iTheatre, iOdeon, iWaterPuppetTheatre, iHippodrome, iPavilion, iArena, iBallCourt, iCharreadaArena, 
iGarden, iLighthouse, iGudang, iTradingPost, iJeweller, iObsidianWorkshop, iMarket, iForum, iGlassmaker, iCaravanserai, 
iJail, iSacrificialAltar, iKalliu, iDivan, iBath, iReservoir, iHammam, iForge, iBloomeryBuilding, iMetalworker, 
iMint, iArtStudio, iCastle, iCitadel, iIslandFort, iPharmacy, iApothecary, iAlchemist, iGrocer, iPostOffice, 
iTambo, iWharf, iVolok, iCoffeehouse, iSalon, iBank, iRoyalExchange, iConstabulary, iMountedPolice, iCustomsHouse, 
...
iAssemblyPlant, iZaibatsu, iDistillery, iPark, iBagh, iCoalPlant, iRailwayStation, iLaboratory, iResearchInstitute, iAbattoir, 
...
iJuliusCaesar, iAugustus, iBrennus, iPacal, iRajendra, iKrishnaDevaRaya, iEzana, iZaraYaqob, iMenelik, iTopiltzin, 
iKanishka, iWangKon, iSejong, iSuryavarman, iJustinian, iBasil, iSriJayanasa, iTunPerak, iKammu, iOdaNobunaga, 
iMeiji, iRagnar, iChristian, iGerhardsen, iBumin, iAlpArslan, iTamerlane, iHarun, iSaladin, iSongtsen, 
iLobsangGyatso, iRahman, iYaqub, iHayamWuruk, iSuharto, iIsabella, iPhilip, iFranco, iCharlemagne, iLouis, 
iNapoleon, iDeGaulle, iAlfred, iElizabeth, iVictoria, iChurchill, iBarbarossa, iCharles, iFrancis, iAnawrahta, 
iBayinnaung, iYaroslav, iLeLoi, iDawud, iMansaMusa, iCasimir, iSobieski, iPilsudski, iWalesa, iAfonso, 
