...
iRedFort, iVersailles, iForbiddenPalace, iSpiralMinaret, iDomeOfTheRock, iHouseOfWisdom, iUniversityOfSankore, iTajMahal, iOxfordUniversity, iSanMarcoBasilica, 
iPorcelainTower, iSaintBasilsCathedral, iEscorial, iTorreDeBelem, iHarmandirSahib, iTrafalgarSquare, iPotalaPalace, iShalimarGardens, iImageOfTheWorldSquare, iBourse, 
iItsukushimaShrine, iLouvre, iHermitage, iSaltCathedral, iAmberRoom, iEmeraldBuddha, iGuadalupeBasilica, iAbbeyMills, iBellRockLighthouse, iBrandenburgGate, 
iStatueOfLiberty, iTriumphalArch, iMoleAntonelliana, iNobelPrize, iMetropolitain, iNeuschwanstein, iBrooklynBridge, iMenloPark, iCrystalPalace, iTsukijiFishMarket, 
iPentagon, iMotherlandCalls, iLubyanka, iWestminsterPalace, iEiffelTower, iEmpireStateBuilding, iLasLajasSanctuary, iPalaceOfNations, iSagradaFamilia, iBerlaymont, 
iCERN, iBletchleyPark, iWembley, iGraceland, iCristoRedentor, iItaipuDam, iHollywood, iUnitedNations, iCNTower, iCrystalCathedral, 
iGoldenGateBridge, iAtomium, iGlobalSeedVault, iWorldTradeCenter, iHarbourOpera, iLotusTemple, iBurjKhalifa, iHubbleSpaceTelescope, iChannelTunnel, iDeltaWorks, 
iIronDome, iOrientalPearlTower, iSkytree, iGardensByTheBay, iSpaceElevator, iLargeHadronCollider, iITER) = range(iNumBuildings)
