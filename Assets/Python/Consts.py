...
# TODO: add iIran, iMexico, iColombia everywhere
...
iCivGroupMiddleEast : [iEgypt, iBabylonia, iPersia, iByzantium, iArabia, iOttomans, iCarthage, iTurks],
iCivGroupAfrica : [iEgypt, iCarthage, iEthiopia, iMali, iCongo],
iCivGroupAmerica : [iMaya, iInca, iAztecs, iAmerica, iArgentina, iBrazil, iCanada],
}
...
dTechGroups = {
iTechGroupWestern : [iRome, iGreece, iByzantium, iVikings, iSpain, iFrance, iEngland, iHolyRome, iRussia, iNetherlands, iPoland, iPortugal, iItaly, iGermany, iAmerica, iArgentina, iBrazil, iCanada],
iTechGroupMiddleEast : [iEgypt, iBabylonia, iHarappa, iIndia, iCarthage, iPersia, iEthiopia, iArabia, iMoors, iMali, iOttomans, iMughals, iTamils, iCongo, iTurks],
...
dNeighbours = CivDict({
iEgypt : [iBabylonia, iGreece, iPersia, iCarthage, iRome, iEthiopia, iByzantium, iArabia, iMoors, iOttomans],
iBabylonia : [iEgypt, iGreece, iPersia, iTurks, iOttomans, iMongols, iCarthage, iByzantium],
iHarappa : [iIndia, iPersia, iTamils, iTibet, iMughals],
iChina : [iIndia, iJapan, iKorea, iTurks, iTibet, iKhmer, iMongols, iThailand],
iGreece : [iPersia, iCarthage, iRome, iByzantium, iHolyRome, iRussia, iOttomans, iItaly],
iIndia : [iChina, iHarappa, iPersia, iTamils, iTibet, iKhmer, iMongols, iMughals, iThailand],
iCarthage : [iEgypt, iGreece, iRome, iSpain, iMali, iPortugal, iBabylonia, iPersia, iArabia, iMoors, iOttomans, iItaly],
iPersia : [iIndia, iBabylonia, iHarappa, iGreece, iTurks, iByzantium, iOttomans, iMongols, iCarthage, iMughals],
iRome : [iEgypt, iBabylonia, iGreece, iCarthage, iSpain, iFrance, iHolyRome, iPortugal, iItaly, iGermany],
iTamils : [iHarappa, iIndia, iKhmer, iIndonesia, iMughals, iThailand],
iEthiopia : [iEgypt, iArabia, iMali, iCongo],
iKorea : [iChina, iKorea, iMongols],
iMaya : [iSpain, iInca, iAztecs, iAmerica],
iByzantium : [iEgypt, iBabylonia, iGreece, iPersia, iArabia, iRussia, iOttomans, iTurks],
iJapan : [iChina, iKorea, iKhmer, iMongols, iThailand],
iVikings : [iFrance, iEngland, iHolyRome, iRussia, iPoland, iNetherlands, iGermany],
iTurks : [iChina, iBabylonia, iPersia, iMughals, iOttomans, iByzantium, iMongols, iTibet],
iArabia : [iEgypt, iBabylonia, iPersia, iEthiopia, iByzantium, iOttomans, iCarthage],
iTibet : [iChina, iHarappa, iIndia, iMongols, iMughals, iTurks],
iIndonesia : [iIndia, iJapan, iKhmer, iThailand, iTamils],
iMoors : [iEgypt, iSpain, iPortugal, iMali],
iSpain : [iCarthage, iRome, iMoors, iFrance, iEngland, iPortugal],
iFrance : [iRome, iVikings, iSpain, iEngland, iHolyRome, iNetherlands, iPortugal, iItaly, iGermany],
iKhmer : [iIndia, iChina, iTamils, iJapan, iIndonesia, iThailand],
iEngland : [iRome, iVikings, iSpain, iFrance, iHolyRome, iNetherlands, iGermany],
iHolyRome : [iRome, iVikings, iFrance, iEngland, iNetherlands, iItaly, iPoland, iGermany],
iRussia : [iPersia, iByzantium, iVikings, iPoland, iOttomans, iMongols, iGermany],
iMali : [iEgypt, iCarthage, iEthiopia, iMoors, iCongo],
iPoland : [iVikings, iHolyRome, iRussia, iGermany],
iPortugal : [iCarthage, iRome, iSpain, iFrance],
iInca : [iSpain, iAztecs, iAmerica, iArgentina, iBrazil],
iItaly : [iGreece, iCarthage, iRome, iFrance, iHolyRome],
iMongols : [iIndia, iChina, iPersia, iJapan, iKorea, iTibet, iRussia, iOttomans, iTurks],
iAztecs : [iSpain, iInca, iAmerica],
iMughals : [iHarappa, iIndia, iPersia, iTamils, iTibet, iTurks],
iOttomans : [iBabylonia, iGreece, iPersia, iByzantium, iRussia, iMongols, iCarthage, iTurks],
iThailand : [iIndia, iChina, iJapan, iIndonesia, iKhmer, iTamils],
iCongo : [iEthiopia, iMali],
iNetherlands : [iVikings, iFrance, iEngland, iHolyRome, iGermany],
iGermany : [iRome, iVikings, iFrance, iEngland, iHolyRome, iRussia, iPoland, iNetherlands],
iAmerica : [iJapan, iSpain, iFrance, iEngland, iRussia, iInca, iAztecs],
iArgentina : [iSpain, iPortugal, iInca, iBrazil],
iBrazil : [iSpain, iPortugal, iInca, iArgentina],
iCanada : [iAmerica],
}, [])
