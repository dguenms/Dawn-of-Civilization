...
iObelisk, iMenhir, iStele, iCandi, iEdict, iMalae, iMudbrickPyramid, iTotemPole, iWalls, iDun, 
iStable, iKalliu, iOrtege, iLibrary, iEdubba, iTaixue, iKyaung, iCalmecac, iHarbor, iAqueduct, 
...
iNumGreatWonders = 136 # different from DLL constant because that includes national wonders
...
iSkytree, iOrientalPearlTower, iDeltaWorks, iSpaceElevator, iLargeHadronCollider, iITER) = range(iFirstWonder, iNumBuildings)
...
iPeriodVijayanagara, iPeriodIndianKushans, iPeriodByzantineConstantinople, iPeriodSeljuks, iPeriodMeiji, 
