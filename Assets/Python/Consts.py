...
iWarriorCode, iFeudalism, iMachinery, iAlchemy, iCivilService, iJudiciary, iTheology,
iSiegecraft, iCropRotation, iGuilds, iCompass, iPaper, iPatronage, iClergy,
iGunpowder, iUrbanism, iFinance, iCartography, iPrinting, iEducation, iLiterature,
...
# iAviation, iRocketry, iFission, iElectronics, iTelevision, iTourism, iPharmaceuticals,
iBallistics, iEngine, iRailroad, iElectricity, iRefrigeration, iLaborUnions, iJournalism,
...
iAviation, iRocketry, iFission, iElectronics, iTelevision, iTourism, iActivism,
iRadar, iSpaceflight, iNuclearPower, iLaser, iComputers, iGlobalization, iEcology,
...
iUnifiedTheory, iArtificialIntelligence, iTranshumanism) = range(iNumTechs)

lAncientTechs = [i for i in range(21)]
lClassicalTechs = [i for i in range(42)]
lMedievalTechs = [i for i in range(63)]
lRenaissanceTechs = [i for i in range(84)]
lIndustrialTechs = [i for i in range(105)]
lModernTechs = [i for i in range(126)]
...
iSamInfantry, iMobileSam, iMarine, iAmericanNavySeal, iParatrooper, iMechanizedInfantry, iArcher, iBabylonAsharittuBowman, iNubianMedjay, iSkirmisher, iMayanHolkan, iMandeSkirmisher,
iLongbowman, iIndianPatiyodha, iCrossbowman, iChineseChokonu, iChariot, iEgyptianWarChariot, iHittiteHuluganni, iCelticCidainh, iHorseman, iNumidianCavalry, iKushanAsvaka,
iHorseArcher, iArabianCamelArcher, iTibetanKhampa, iKnight, iMongolianKeshik, iByzantineCataphract, iThaiChangSuek, iSeljukGhulamWarrior,
...
iJetFighter, iBomber, iStealthBomber, iGuidedMissile, iNuclearBomber, iIcbm, iGreatProphet, iGreatArtist, iGreatScientist, iGreatMerchant, iGreatEngineer, iGreatStatesman, iGreatGeneral,
...
iMongolianGer, iBunker, iBombShelter, iGranary, iIncanTerrace, iSmokehouse, iAqueduct, iOttomanHammam, iKhmerBaray, iMoorishNoria, iHarappanBath, iIndianStepwell, iBath,
iPharmacy, iSewer, iPark, iHospital, iRecyclingCenter, iLighthouse, iVikingTradingPost, iHarbor, iCustomHouse, iPortugueseFeitoria, iWharf, iPostOffice, iDrydock, iAirport,
iForge, iMandeMint, iItalianArtStudio, iArabianAlchemist, iFactory, iGermanAssemblyPlant, iJapaneseZaibatsu, iCoalPlant, iHydroPlant, iNuclearPlant, iSolarPlant, iElectricalGrid,
iIndustrialPark, iPaganTemple, iBabylonianZiggurat, iMonument, iEgyptianObelisk, iEthiopianStele, iIndonesianCandi, iIndianEdict, iNativeAmericanTotemPole, iPublicTransportation,
iLibrary, iChineseTaixue, iThaiHoTrai, iTamilSangam, iUniversity, iKoreanSeowon, iTibetanGompa, iObservatory, iLaboratory, 
iRussianResearchInstitute, iWeaver, iTheatre, iGreekOdeon, iByzantineHippodrome, iChinesePavillion, iAmphitheatre, iMayanBallCourt, iMexicanCharreada, 
iPolynesianMalae, iBabylonianGarden, iCinema, iBroadcastTower, iMarket, iRomanForum, iPersianApothecary, iIranianCaravanserai, iCongoleseMbwadi, iPhoenicianGlassmaker, 
iGrocer, iBrazilianFazenda, iColombianHacienda, iBank, iEnglishRoyalExchange, iRailwayStation, iDepartmentStore, iSupermarket, iAmericanMall, iArgentineRefrigerationPlant, iCoffeeHouse, iDistillery, iHotel,
iConstabulary, iCivicSquare, iEstate, iNewsPress, iCourthouse, iAztecSacrificialAltar, iHolyRomanRathaus, iPolishSejmik, iJail, iFrenchSalon, iMughalMausoleum, iCanadianRoyalMountedPolice, iLevee, 
...
iNumLeaders = 121
(iLeaderBarbarian, iNativeLeader, iIndependentLeader, iAlexander, iAsoka, iAugustus, iBismarck, iBoudica, iBrennus, iCatherine, 
...
iFranco, iNicholas, iCavour, iAbbas, iKhomeini, iTaizong, iHongwu, iDharmasetu, iHayamWuruk, iSuharto, 
