...
iTechGroupMiddleEast : [iEgypt, iBabylonia, iHarappa, iAssyria, iHittites, iIndia, iCarthage, iNubia, iPersia, iEthiopia, iKushans, iMali, iArabia, iMoors, iSwahili, iOttomans, iMughals, iDravidia, iCongo, iTurks, iIran],
...
iKalliu, iOrtege, iLibrary, iEdubba, iTaixue, iKyaung, iHoTrai, iSangam, iCalmecac, iHarbor, 
iAqueduct, iQanat, iBaray, iNoria, iStepwell, iTheatre, iOdeon, iWaterPuppetTheatre, iHippodrome, iPavilion, 
iArena, iBallCourt, iCharreadaArena, iGarden, iLighthouse, iGudang, iTradingPost, iJeweller, iGlassmaker, iObsidianWorkshop, 
iMarket, iForum, iCaravanserai, iWangara, iJail, iDivan, iBath, iReservoir, iHammam, iForge, 
iBloomeryBuilding, iMetalworker, iArtStudio, iCastle, iCitadel, iIslandFort, iPharmacy, iAlchemist, iGrocer, iPostOffice, 
iTambo, iWharf, iVolok, iCoffeehouse, iSalon, iBank, iConstabulary, iMountedPolice, iCustomsHouse, iFeitoria, 
iUniversity, iSeowon, iGompa, iCivicSquare, iRathaus, iSejmik, iSewer, iStarFort, iEstate, iMausoleum, 
iFazenda, iHacienda, iDrydock, iLevee, iDike, iObservatory, iWarehouse, iCourthouse, iExchequer, iFactory, 
