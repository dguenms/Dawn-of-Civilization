...
lCivilizations = [
	Civilization(
		...
		techs=techs.column(9).without(iCompanies, iFinance, iHumanities).including(iStatecraft),
		dAttitudes={iKorea: 2},
	),
	Civilization(
		iDravidia,
		...
		techs=techs.column(8).without(iDoctrine).including(iCompanies),
		dAtttitudes={iMughals: -2},
		dMemories={
	...
	Civilization(
		...
		techs=techs.column(8).without(iPaper, iCompass),
	),
	Civilization(
		iKorea,
		iLeader=iSejong,
	...
	Civilization(
		...
		techs=techs.column(8).without(iPaper, iCompass, iPatronage),
		dAttitudes={iMoors: -2},
		dMemories={
	...
	Civilization(
		...
		dAttitudes={iEngland: -4, iHolyRome: -4, iItaly: -2},
		dMemories={
	...
	Civilization(
		...
		techs=techs.column(8).including(iGunpowder, iHumanities, iPrinting, iJudiciary),
	),
	Civilization(
		iNorse,
		iLeader=iChristian,
		...
		techs=techs.column(8).without(iCompass),
		dAttitudes={iSweden: -2, iHolyRome: 2},
		dMemories={
	...
	Civilization(
		...
		techs=techs.column(8).without(iCropRotation, iEducation),
		dAttitudes={iIran: -2},
		dMemories={
	...
	Civilization(
		...
		techs=techs.column(8).without(iCommune, iCompass),
		dAttitudes={iSpain: -4, iOttomans: -2},
		dMemories={
	...
	Civilization(
		...
		techs=techs.column(8).without(iEducation, iPatronage).including(iGunpowder),
	),
	Civilization(
		iSpain,
		iLeader=iPhilip,
		...
		iGold=300,
		lCivics=[iMonarchy, iVassalage, iManorialism, iMerchantTrade, iClergy, iHegemony],
		techs=techs.column(8).including(iGunpowder, iCartography),
		dAttitudes={iMoors: -4, iPortugal: 2},
		dMemories={
	...
	Civilization(
		...
		techs=techs.column(8).without(iCompass).including(iGunpowder, iHumanities, iPrinting),
		dAttitudes={iFrance: -4, iOttomans: -4, iItaly: -2, iNorse: 2},
		dMemories={
	...
	Civilization(
		...
		techs=techs.column(7).including(iCommune, iCropRotation),
		dAttitudes={iThailand: -2},
		dMemories={
	...
	Civilization(
		...
		iGold=100,
		lCivics=[iMonarchy, iVassalage, iCasteSystem, iRedistribution, iMonasticism, iThalassocracy],
		techs=techs.column(8).without(iCompass, iDoctrine).including(iGunpowder),
		dAttitudes={iChina: 2},
	),
	Civilization(
		iSwahili,
	...
	Civilization(
		...
		iStateReligion=iIslam,
		lCivics=[iDespotism, iVassalage, iSlavery, iMerchantTrade, iClergy, iHegemony],
		techs=techs.column(8).without(iCompass).including(iGunpowder),
	...
	Civilization(
		...
		dAttitudes={iRussia: -2, iHolyRome: -2, iOttomans: -4},
		dMemories={
	...
	Civilization(
		...
		iStateReligion=iCatholicism,
		iGold=200,
		lCivics=[iRepublic, iCitizenship, iManorialism, iMerchantTrade, iClergy, iKinship],
		techs=techs.column(8).including(iCompanies, iFinance, iHumanities),
		dAttitudes={iHolyRome: -2, iFrance: -2},
		dMemories={
	...
	Civilization(
		...
		iGold=100,
		lCivics=[iMonarchy, iVassalage, iManorialism, iMerchantTrade, iClergy, iHegemony],
		techs=techs.column(8).without(iCompass).including(iGunpowder, iCompanies),
		dAttitudes={iNorse: -2, iRussia: -2},
		dMemories={
	...
	Civilization(
		...
		techs=techs.column(8).without(iCompass, iEducation).including(iGunpowder),
		dAttitudes={iPoland: -4, iSweden: -2, iOttomans: -2},
		dMemories={
	...
	Civilization(
		...
		techs=techs.column(8).including(iGunpowder, iJudiciary),
		dAttitudes={iHolyRome: -4, iPoland: -4, iMisr: -4, iRussia: -2, iIran: -2},
		dMemories={
			iHolyRome: {MemoryTypes.MEMORY_DECLARED_WAR: 4},
			iPoland: {MemoryTypes.MEMORY_DECLARED_WAR: 4},
	...
	Civilization(
		...
		techs=techs.column(8).including(iGunpowder, iCompanies, iJudiciary),
		dAttitudes={iOttomans: -2},
		dMemories={
			iOttomans: {MemoryTypes.MEMORY_DENIED_RELIGION: 2},
		},
