...
#ifdef _USRDLL
#define MAX_CIV_PLAYERS												(45) //Rhye, Leoreth: +14 for Byzantium, Korea, Indonesia, Mughals, Thailand, Seljuks, Prussia/HRE, Italy, Tamils, Poland, Moors, Congo, Tibet, Brazil
#else
