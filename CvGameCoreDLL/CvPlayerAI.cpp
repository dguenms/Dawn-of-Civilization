...
/************************************************************************************************/
								...
								case SPAIN:
									...
									break;
								case FRANCE:
									if (iI == EXPLORATION || iI == GEOGRAPHY || iI == LOGISTICS || iI == PATRONAGE || iI == MEASUREMENT)
										iValue *= 2;
								...
								case AZTECS:
									...
									break;
								case NETHERLANDS:
									if (iI == EXPLORATION || iI == OPTICS || iI == GEOGRAPHY || iI == REPLACEABLE_PARTS || iI == LOGISTICS || iI == ECONOMICS || iI == CIVIL_LIBERTIES)
										iValue *= 2;
									if (iI == CHEMISTRY) {
										iValue *= 3;
										iValue /= 2;
