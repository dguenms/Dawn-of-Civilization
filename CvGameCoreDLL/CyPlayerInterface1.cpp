...
void CyPlayerPythonInterface1(python::class_<CyPlayer>& x)
{
	...
	x
		...
		.def("setStability", &CyPlayer::setStability, "void (int iNewValue)")
		.def("changeStability", &CyPlayer::changeStability, "void (int iChange)")
		.def("getGreatDepressionCountdown", &CyPlayer::getGreatDepressionCountdown, "int ()")
		.def("setGreatDepressionCountdown", &CyPlayer::setGreatDepressionCountdown, "void (int iNewValue)")
		.def("getCombatResultTempModifier", &CyPlayer::getCombatResultTempModifier, "int ()")
		.def("setCombatResultTempModifier", &CyPlayer::setCombatResultTempModifier, "void (int iNewValue)")
		.def("changeCombatResultTempModifier", &CyPlayer::changeCombatResultTempModifier, "void (int iChange)")
		.def("getBaseStabilityLastTurn", &CyPlayer::getBaseStabilityLastTurn, "int ()")
