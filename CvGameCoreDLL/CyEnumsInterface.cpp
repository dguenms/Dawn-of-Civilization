...
void CyEnumsPythonInterface()
{
	...
	python::enum_<WidgetTypes>("WidgetTypes")
		...
		.value("WIDGET_HELP_REMOVE", WIDGET_HELP_REMOVE) // doc
		...
		.value("WIDGET_HELP_STABILITY_EXPANSION", WIDGET_HELP_STABILITY_EXPANSION) // doc
		.value("WIDGET_HELP_STABILITY_ECONOMY", WIDGET_HELP_STABILITY_ECONOMY) // doc
		.value("WIDGET_HELP_STABILITY_DOMESTIC", WIDGET_HELP_STABILITY_DOMESTIC) // doc
		.value("WIDGET_HELP_STABILITY_FOREIGN", WIDGET_HELP_STABILITY_FOREIGN) // doc
		.value("WIDGET_HELP_STABILITY_MILITARY", WIDGET_HELP_STABILITY_MILITARY) // doc
		.value("WIDGET_HELP_STABILITY", WIDGET_HELP_STABILITY) // doc

		.value("WIDGET_HELP_GREAT_SPY", WIDGET_HELP_GREAT_SPY) // doc
		.value("WIDGET_HELP_BONUS_PLAYER_TRADE", WIDGET_HELP_BONUS_PLAYER_TRADE) // doc

		.value("WIDGET_HELP_BONUS_CITY", WIDGET_HELP_BONUS_CITY) // doc

		.value("WIDGET_CHOOSE_EVENT", WIDGET_CHOOSE_EVENT)
		.value("WIDGET_PEDIA_JUMP_TO_TECH", WIDGET_PEDIA_JUMP_TO_TECH)
		.value("WIDGET_PEDIA_JUMP_TO_CULTURE_LEVEL", WIDGET_PEDIA_JUMP_TO_CULTURE_LEVEL) // doc
		...
		.value("WIDGET_PEDIA_JUMP_TO_ROUTE", WIDGET_PEDIA_JUMP_TO_ROUTE) // doc
		...
		.value("WIDGET_PEDIA_JUMP_TO_PAGAN_RELIGION", WIDGET_PEDIA_JUMP_TO_PAGAN_RELIGION) // doc
		...
		.value("WIDGET_FINANCE_ADVISOR", WIDGET_FINANCE_ADVISOR) // doc
		// K-Mod widgets
        ...
        .value("WIDGET_HELP_WONDER_LIMIT", WIDGET_HELP_WONDER_LIMIT) // doc
        .value("WIDGET_HELP_SATELLITE_LIMIT", WIDGET_HELP_SATELLITE_LIMIT) // doc
        .value("WIDGET_FIRST_DISCOVERED", WIDGET_FIRST_DISCOVERED) // doc
	...
	python::enum_<PlayerOptionTypes>("PlayerOptionTypes")
		...
		.value("PLAYEROPTION_MODDER_1", PLAYEROPTION_HIDE_AIR_CIRCLING) // doc
	...
	python::enum_<MissionTypes>("MissionTypes")
        ...
        .value("MISSION_ESPIONAGE", MISSION_ESPIONAGE) // doc
        .value("MISSION_RESOLVE_CRISIS", MISSION_RESOLVE_CRISIS) // doc
        .value("MISSION_REFORM_GOVERNMENT", MISSION_REFORM_GOVERNMENT) // doc
        .value("MISSION_DIPLOMATIC_MISSION", MISSION_DIPLOMATIC_MISSION) // doc
        .value("MISSION_PERSECUTE", MISSION_PERSECUTE) // doc
        .value("MISSION_GREAT_MISSION", MISSION_GREAT_MISSION) // doc
	...
	python::enum_<MissionAITypes>("MissionAITypes")
		...
		.value("MISSIONAI_CIRCUMNAVIGATE", MISSIONAI_CIRCUMNAVIGATE) // doc
		;
	...
	python::enum_<ControlTypes>("ControlTypes")
		...
		.value("CONTROL_STABILITY_OVERLAY", CONTROL_STABILITY_OVERLAY) // doc (edead)
	...
	python::enum_<TradeableItems>("TradeableItems")
		...
		.value("TRADE_SLAVE", TRADE_SLAVE) // doc (edead)
	...
	python::enum_<ReplayMessageTypes>("ReplayMessageTypes")
		...
		.value("REPLAY_MESSAGE_CIV_ASSIGNED", REPLAY_MESSAGE_CIV_ASSIGNED) // doc
