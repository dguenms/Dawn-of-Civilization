...
void CvEventReporter::changeWar(bool bWar, TeamTypes eTeam, TeamTypes eOtherTeam, bool bGlobalWar)
{
	m_kPythonEventMgr.reportChangeWar(bWar, eTeam, eOtherTeam, bGlobalWar);
}
