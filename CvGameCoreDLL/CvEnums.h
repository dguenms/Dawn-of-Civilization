...
ENUM_START(Route, ROUTE)
	ROUTE_ROAD,
	ROUTE_RAILROAD,
	ROUTE_ROMAN_ROAD,
	ROUTE_HIGHWAY,
ENUM_END(Route, ROUTE)
...
ENUM_START(Building, BUILDING)
	FIRST_NATIONAL_WONDER = 188, // increment if normal building (i.e. not national or great wonder) is added

	TRADING_COMPANY = FIRST_NATIONAL_WONDER,
	...
	GREAT_SPHINX = FIRST_GREAT_WONDER,
	PYRAMIDS,
	ORACLE,
	GREAT_WALL,
	ISHTAR_GATE,
	...
	PLAGUE,
ENUM_END(Building, BUILDING)

ENUM_START(BuildingClass, BUILDINGCLASS)
	BUILDINGCLASS_PALACE,
ENUM_END(BuildingClass, BUILDINGCLASS)
...
ENUM_START(Handicap, HANDICAP)
	HANDICAP_HEIR,
	HANDICAP_REGENT,
	HANDICAP_MONARCH,
	HANDICAP_EMPEROR,
	HANDICAP_PARAGON,
ENUM_END(Handicap, HANDICAP)
...
ENUM_START(CulturePlot, CULTUREPLOT)
	FIRST_CULTURE_PLOT = 0,
	LAST_CITY_RADIUS_CULTURE_PLOT = LAST_CITY_PLOT,
	LAST_CULTURE_PLOT = 36,
ENUM_END(CulturePlot, CULTUREPLOT)
#define NUM_CULTURE_PLOTS ((int)NUM_CULTUREPLOT_TYPES) 

ENUM_START(GameSpeed, GAMESPEED)
	GAMESPEED_MARATHON,
	GAMESPEED_EPIC,
	GAMESPEED_NORMAL,
ENUM_END(GameSpeed, GAMESPEED)

ENUM_START(Impact, IMPACT)
	IMPACT_MARGINAL,
	IMPACT_LIMITED,
	IMPACT_SIGNIFICANT,
	IMPACT_CRITICAL,
	IMPACT_PLAYER,
ENUM_END(Impact, IMPACT)
