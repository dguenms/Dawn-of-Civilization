...
public:
    ...
    bool hasBuilding(int /*BuildingTypes*/ eBuilding); // rfc
    bool hasActiveBuilding(int /*BuildingTypes*/ eBuilding); // rfc
	...
	int getRegionID(); // doc
	void setWeLoveTheKingDay(bool bNewValue); // doc
	...
	void setInfoDirty(bool bNewValue); // doc (edead)
	void setLayoutDirty(bool bNewValue); // doc (edead)
	bool isPlundered();
	void setPlundered(bool bNewValue);
	int /*PlayerTypes*/getOwner();
	int /*TeamTypes*/getTeam();
	int getPreviousCiv(); // doc
	int getOriginalCiv(); // doc
	...
	int calculateCulturePercent(int eCivilization); // doc
	int calculateOverallCulturePercent(int ePlayer); // doc
	...
	bool isEverOwnedCiv(int iCivilization); // doc
	...
	bool isHasRealBuilding(int /*BuildingTypes*/ eBuilding); // rfc
	void setHasRealBuilding(int /*BuildingTypes*/ eBuilding, bool bNewValue); // rfc
	...
	int getTradeRoutes();
	int getReligionCount(); // doc (edead)
	...
	void changeBuildingYieldChange(int /*BuildingClassTypes*/ eBuildingClass, int /*YieldTypes*/ eYield, int iChange); // doc
	...
	void updateBuildingCommerce(); // doc

	int getLiberationPlayer(bool bConquest);
	void liberate(bool bConquest);

    void changeBuildingCommerceChange(int eBuildingClass, int eCommerce, int iChange); // doc
	...
	int getGameTurnPlayerLost(int ePlayer); // doc
	int getGameTurnCivLost(int iCivilization); // doc
	...
	CyPlot* getCulturePlot(int i) const; // doc
	int getCultureCost(int i) const; // doc
	void updateCultureCosts(); // doc
	void updateCoveredPlots(); // doc
	void updateGreatWall(); // doc
	void replaceReligion(int eOldReligion, int eNewReligion); // doc
	void removeReligion(int eReligion); // doc
	void spreadReligion(int eReligion); // doc
	void setBuildingOriginalOwner(int eBuilding, int eCivilization); // doc
	void setBuildingOriginalTime(int eBuilding, int iYear); // doc
	void triggerMeltdown(int eBuilding); // doc
	bool isColony(); // doc
	bool hasBonusEffect(int iBonus); // doc
	int getCultureRank(); // doc
	bool isHasBuildingEffect(int eBuilding); // doc
	int getStabilityPopulation(); // doc
	void setStabilityPopulation(int iNewValue); // doc
	int getModifiedCultureRateTimes100(); // doc
	int getModifiedCultureRate(); // doc
	int getNumActiveWorldWonders(); // doc
	bool isCore(int iCivilization); // doc
	bool isPlayerCore(int iPlayer); // doc
	bool isOwnerCore(); // doc
	int getActualCulture(int iPlayer); // doc
	int getTotalPopulationLoss(); // doc
	int countSatellites(); // doc
	...
	void setGameTurnAcquired(int iNewValue); // doc
	void setCivCulture(int iCiv, int iNewValue); // doc
	bool isOriginalOwner(int iPlayer); // doc
	int getCorporationBadHappiness(); // doc
	int getCorporationCount(); // doc
	void doPlotCulture(bool bUpdate, int ePlayer, int iCultureRate, bool bOwned); // doc
	int getHurryPercentAnger(); // doc
	int getConscriptPercentAnger(); // doc
	bool canBeSelected(); // doc
