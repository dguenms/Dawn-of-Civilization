...
void CyPlotPythonInterface1(python::class_<CyPlot>& x)
{
	...
	x
		...
		.def("getSettlerValue", &CyPlot::getSettlerValue, "int (int ePlayer)")
		.def("setSettlerValue", &CyPlot::setSettlerValue, "void (int ePlayer, int iNewValue)")
		.def("getWarValue", &CyPlot::getWarValue, "int (int ePlayer)")
		.def("setWarValue", &CyPlot::setWarValue, "void (int ePlayer, int iNewValue)")
		...
		.def("getActualTotalCulture", &CyPlot::getActualTotalCulture, "int ()")
