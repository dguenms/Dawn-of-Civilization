...
#define PAYA					(153)
#define MOAI					(154)
#define APOSTOLIC				(162)
#define LEANINGTOWER			(163)
#define OLYMPICPARK				(164)
#define SOLOMON                 (165)
#define ISHTAR                  (166)
#define THEODOSIAN              (167)
#define TERRACOTTA              (168)
#define MEZQUITA                (169)
#define DOMEROCK                (170)
#define TOPKAPI                 (171)
#define BRANDENBURG             (172)
#define SANMARCO                (173)
#define WESTMINSTER             (174)
#define BOROBUDUR               (176)
#define KHAJURAHO               (177)
#define HIMEJI                  (178)
#define PORCELAIN               (179)
#define HARMANDIR_SAHIB         (180)
#define GREAT_BATH              (181)

#define NUM_WONDERS             (182)

#define NUM_BUILDINGS_PLAGUE	(183)

#define NUM_BUILDINGTYPES_PLAGUE	(144)
