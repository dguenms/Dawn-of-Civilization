...
enum MyBuildings
{
  ...
  BLUE_MOSQUE = BEGIN_WONDERS+65,
  RED_FORT = BEGIN_WONDERS+66,
  VERSAILLES = BEGIN_WONDERS+67,
  TRAFALGAR = BEGIN_WONDERS+68,
  EMPIRE_STATE = BEGIN_WONDERS+69,
  GRAND_CANAL = BEGIN_WONDERS+70,
  FLOATING_GARDENS = BEGIN_WONDERS+71,
  LUBYANKA = BEGIN_WONDERS+72,
  MACHU_PICCHU = BEGIN_WONDERS+73,
  CN_TOWER = BEGIN_WONDERS+74,
};
